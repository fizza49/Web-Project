...
import { Menu, X, User, LogOut, Bell, Settings, Sparkles, Zap, Home, CreditCard, PieChart, MessageSquare } from 'lucide-react';
            ...
            >
              <div className="relative">
                ...
                <div className="relative w-10 h-10 bg-gradient-to-r from-white to-gray-100 rounded-2xl flex items-center justify-center shadow-lg transform group-hover:scale-110 transition-all duration-500">
                  <span className="text-transparent bg-gradient-to-r from-primary to-primary-dark bg-clip-text font-bold text-xl">E</span>
                </div>
